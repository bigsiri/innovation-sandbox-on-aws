...
export const UserLambdaEnvironmentSchema = BaseLambdaEnvironmentSchema.extend({
...
export type UserLambdaEnvironment = z.infer<typeof UserLambdaEnvironmentSchema>;
